...
export class OracleFeedValuesEvent {
   ...
   */
  get isV1(): boolean {
    return this._chain.getEventHash('Oracle.FeedValues') === '3b4b93a6dae57862d440fff55bea297ee17d31135418d17f57328cacdf0a0c7e'
  }
   ...
   * Event emitted when exchange rate is set
   */
  get asV3(): [Uint8Array, [v3.Key, bigint][]] {
    assert(this.isV3)
    return this._chain.decodeEvent(this.event)
  }
...
export class RedeemCancelRedeemEvent {
  ...
  get isV1(): boolean {
    return this._chain.getEventHash('Redeem.CancelRedeem') === '89a9db7040ea8c8edb842cad6a713f9fbd227582910735d3b562ea8f2be62f16'
  }
...
export class RefundExecuteRefundEvent {
  ...
  constructor(ctx: EventContext, event?: Event) {
    event = event || ctx.event
    assert(event.name === 'Refund.ExecuteRefund')
    this._chain = ctx._chain
    this.event = event
  }
   ...
   */
  get isV1(): boolean {
    return this._chain.getEventHash('Refund.ExecuteRefund') === 'a5dc8bda10a27e8070d75f51229df149f3485d4ec223fbdec3c9f1f1e95b2101'
  }
   ...
   */
  get isV3(): boolean {
    return this._chain.getEventHash('Refund.ExecuteRefund') === 'a1f3d32d29a387d7b9013ef2d1b13fea592053869403bfdb77f39e02178dbac0'
  }
  ...
  get isV4(): boolean {
    return this._chain.getEventHash('Refund.ExecuteRefund') === '2c132655cffdfc25cb8e674859162c7c19af6fd57f9d0b2c28bbd8e2a28cfc96'
  }

  get asV4(): {refundId: Uint8Array, issuer: Uint8Array, vaultId: v4.VaultId, amount: bigint, fee: bigint} {
    assert(this.isV4)
    return this._chain.decodeEvent(this.event)
  }

  get isV6(): boolean {
    return this._chain.getEventHash('Refund.ExecuteRefund') === '5307d86ae098aebf2ffe2d835bcf6c810a7f63f3918204d07245e2d61fef7286'
  }

  get asV6(): {refundId: Uint8Array, issuer: Uint8Array, vaultId: v6.VaultId, amount: bigint, fee: bigint} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }

  get isV15(): boolean {
    return this._chain.getEventHash('Refund.ExecuteRefund') === '94bc6f77689dd648726d95cd7f3205478aa99084d6afc894c75c0a2a5b010e7a'
  }

  get asV15(): {refundId: Uint8Array, issuer: Uint8Array, vaultId: v15.VaultId, amount: bigint, fee: bigint} {
    assert(this.isV15)
    return this._chain.decodeEvent(this.event)
  }

  get isV17(): boolean {
    return this._chain.getEventHash('Refund.ExecuteRefund') === '94fee728180908c2c66a2421de1de144cc68556c47258a94f0ce5938f3b582a6'
  }

  get asV17(): {refundId: Uint8Array, issuer: Uint8Array, vaultId: v17.VaultId, amount: bigint, fee: bigint} {
    assert(this.isV17)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class RefundRequestRefundEvent {
  ...
  constructor(ctx: EventContext, event?: Event) {
    event = event || ctx.event
    assert(event.name === 'Refund.RequestRefund')
    this._chain = ctx._chain
    this.event = event
  }
   ...
   */
  get isV1(): boolean {
    return this._chain.getEventHash('Refund.RequestRefund') === 'ed413badb4cd87f6a259310edd3b54d092b05b33452ff90edc880cbb9914be43'
  }
   ...
   */
  get isV3(): boolean {
    return this._chain.getEventHash('Refund.RequestRefund') === '0f79a5d0eef44e058d656d8bd600756f93b1bdf9f2d55608d3d45aaed652da82'
  }

  /**
   * refund_id, issuer, amount_without_fee, vault, btc_address, issue_id, fee, transfer_fee
   */
  get asV3(): [Uint8Array, Uint8Array, bigint, v3.VaultId, v3.Address, Uint8Array, bigint, bigint] {
    assert(this.isV3)
    return this._chain.decodeEvent(this.event)
  }

  get isV4(): boolean {
    return this._chain.getEventHash('Refund.RequestRefund') === 'bfb860ed9117ca9a41216457ae1d2e4a5ca16c6f9354be56bf692bc8559630bb'
  }

  get asV4(): {refundId: Uint8Array, issuer: Uint8Array, amount: bigint, vaultId: v4.VaultId, btcAddress: v4.Address, issueId: Uint8Array, fee: bigint, transferFee: bigint} {
    assert(this.isV4)
    return this._chain.decodeEvent(this.event)
  }

  get isV6(): boolean {
    return this._chain.getEventHash('Refund.RequestRefund') === '938eaa1668e8dedad5231eed40eb143b041df37e15f9e538ffc7cee3feca65de'
  }

  get asV6(): {refundId: Uint8Array, issuer: Uint8Array, amount: bigint, vaultId: v6.VaultId, btcAddress: v6.Address, issueId: Uint8Array, fee: bigint, transferFee: bigint} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }

  get isV15(): boolean {
    return this._chain.getEventHash('Refund.RequestRefund') === 'e6581c6458a83c164c3a8c899a2d06bdb47c7ef1e436cc660d12424793eeb20b'
  }

  get asV15(): {refundId: Uint8Array, issuer: Uint8Array, amount: bigint, vaultId: v15.VaultId, btcAddress: v15.Address, issueId: Uint8Array, fee: bigint, transferFee: bigint} {
    assert(this.isV15)
    return this._chain.decodeEvent(this.event)
  }

  get isV17(): boolean {
    return this._chain.getEventHash('Refund.RequestRefund') === '77f94c96c50a3d1a974b0cbb518779a172d929745367f4e917ac7bfd71df8750'
  }

  get asV17(): {refundId: Uint8Array, issuer: Uint8Array, amount: bigint, vaultId: v17.VaultId, btcAddress: v17.Address, issueId: Uint8Array, fee: bigint, transferFee: bigint} {
    assert(this.isV17)
    return this._chain.decodeEvent(this.event)
  }
}
