...
export class BtcRelayStoreBlockHeaderCall {
    ...
    get isV1018000(): boolean {
        return (
            this._chain.getCallHash("BTCRelay.store_block_header") ===
            "0b7de7a970105636591e115c41a12831834dfd0d481ebdf53724537214918766"
        );
    }
    ...
    get asV1019000(): { rawBlockHeader: Uint8Array } {
...
export class SystemSetStorageCall {
    ...
    get isV1(): boolean {
        return (
            this._chain.getCallHash("System.set_storage") ===
            "a4fb507615d69849afb1b2ee654006f9be48bb6e960a4674624d6e46e4382083"
        );
    }
    get isV1019000(): boolean {
        return (
    ...
    get asV1019000(): { items: [Uint8Array, Uint8Array][] } {
        assert(this.isV1019000);
        return this._chain.decodeCall(this.call);
    }
}
