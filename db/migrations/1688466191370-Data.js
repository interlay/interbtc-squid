module.exports = class Data1688466191370 {
    name = 'Data1688466191370'

    async up(db) {
        await db.query(`CREATE TABLE "native_currency_locks" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "type" character varying(10) NOT NULL, "amount" numeric NOT NULL, "amount_human" numeric NOT NULL, "account_id" text NOT NULL, "symbol" text NOT NULL, "token" jsonb NOT NULL, "height_id" character varying, CONSTRAINT "PK_444554f899953efc7eb7c2f573f" PRIMARY KEY ("id"))`)
