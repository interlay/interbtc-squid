module.exports = class Data1681915068551 {
    name = 'Data1681915068551'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "dex_stable_fees" ("id" character varying NOT NULL, "pool_id" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "fee" numeric NOT NULL, "admin_fee" numeric, CONSTRAINT "PK_1b0b10450102adfe5f1df366fac" PRIMARY KEY ("id"))`)
