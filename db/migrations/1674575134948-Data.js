module.exports = class Data1674575134948 {
    name = 'Data1674575134948'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "oracle_update" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "oracle_id" text NOT NULL, "type" character varying(13) NOT NULL, "type_key" jsonb, "update_value" numeric NOT NULL, "update_value_human" text NOT NULL, "height_id" character varying, CONSTRAINT "PK_198859007c7a88cb0b1e6f9234f" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "cumulative_volume_per_currency_pair" ("id" character varying NOT NULL, "type" character varying(12) NOT NULL, "till_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "amount" numeric NOT NULL, "amount_human" text NOT NULL, "wrapped_currency" jsonb, "collateral_currency" jsonb, CONSTRAINT "PK_b55d48297b58de0876411bb8f82" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "token" jsonb NOT NULL, "amount" numeric NOT NULL, "amount_human" text NOT NULL, "from" text NOT NULL, "to" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "height_id" character varying, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
