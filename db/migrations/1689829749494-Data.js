module.exports = class Data1689829749494 {
    name = 'Data1689829749494'

    async up(db) {
        await db.query(`CREATE TABLE "cumulative_circulating_supply" ("id" character varying NOT NULL, "till_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "symbol" text NOT NULL, "amount_circulating" numeric NOT NULL, "amount_circulating_human" numeric NOT NULL, "total_issuance" numeric NOT NULL, "total_issuance_human" numeric NOT NULL, "amount_locked" numeric NOT NULL, "amount_locked_human" numeric NOT NULL, "amount_reserved" numeric NOT NULL, "amount_reserved_human" numeric NOT NULL, "amount_system_accounts" numeric NOT NULL, "amount_system_accounts_human" numeric NOT NULL, "currency" jsonb NOT NULL, "height_id" character varying, CONSTRAINT "PK_66f6b6427d35605e4665395ceca" PRIMARY KEY ("id"))`)
