module.exports = class Data1676475974555 {
    name = 'Data1676475974555'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "vault" ("id" character varying NOT NULL, "account_id" text NOT NULL, "collateral_token" jsonb NOT NULL, "collateral_amount" numeric NOT NULL, "wrapped_token" jsonb NOT NULL, "pending_wrapped_amount" numeric NOT NULL, "wrapped_amount" numeric NOT NULL, "collateralization" numeric, "status_issuing" boolean, "status_collateral" character varying(16) NOT NULL, "registration_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "registration_block_id" character varying, "last_activity_id" character varying, CONSTRAINT "PK_dd0898234c77f9d97585171ac59" PRIMARY KEY ("id"))`)
